...
<head>
    ...
    <title>Attractions Module</title>
</head>
<body>
    <div class="module-container">
        <h1>Attractions Module</h1>
        <form action="attractions" method="post">
            <input type="text" class="input-field" name="attraction_name" placeholder="Enter attraction name...">
            <input type="text" class="input-field" name="location" placeholder="Enter location...">
            <textarea class="input-field" name="description" placeholder="Provide a brief description..."></textarea>
        ...
        <table class="record-table">
            ...
            <tbody>
                ...
                %>
                            <tr>
                                <td><%= rs.getString("attraction_name") %></td>
                            ...
                            <tr class="edit-form" id="editForm<%= rs.getInt("id") %>">
                                <td colspan="4">
                                    <form action="attractions" method="post">
                                        <input type="hidden" name="id" value="<%= rs.getInt("id") %>">
                                        <input type="text" class="input-field" name="edited_attraction_name" value="<%= rs.getString("attraction_name") %>">
                                        <input type="text" class="input-field" name="edited_location" value="<%= rs.getString("location") %>">
                                        <textarea class="input-field" name="edited_description"><%= rs.getString("description") %></textarea>
